[Skip to main content](https://web.dev/learn/pwa/service-workers#main-content)

[![web.dev](https://www.gstatic.com/devrel-devsite/prod/v75e3d64006adca2b8b590c38f10bf440310b485b03499ed9671198292b2883b7/web/images/lockup.svg)](https://web.dev/)

`/`

Language

- [English](https://web.dev/learn/pwa/service-workers)
- [Deutsch](https://web.dev/learn/pwa/service-workers?hl=de)
- [Español – América Latina](https://web.dev/learn/pwa/service-workers?hl=es-419)
- [Français](https://web.dev/learn/pwa/service-workers?hl=fr)
- [Indonesia](https://web.dev/learn/pwa/service-workers?hl=id)
- [Italiano](https://web.dev/learn/pwa/service-workers?hl=it)
- [Polski](https://web.dev/learn/pwa/service-workers?hl=pl)
- [Português – Brasil](https://web.dev/learn/pwa/service-workers?hl=pt-br)
- [Tiếng Việt](https://web.dev/learn/pwa/service-workers?hl=vi)
- [Türkçe](https://web.dev/learn/pwa/service-workers?hl=tr)
- [Русский](https://web.dev/learn/pwa/service-workers?hl=ru)
- [עברית](https://web.dev/learn/pwa/service-workers?hl=he)
- [العربيّة](https://web.dev/learn/pwa/service-workers?hl=ar)
- [فارسی](https://web.dev/learn/pwa/service-workers?hl=fa)
- [हिंदी](https://web.dev/learn/pwa/service-workers?hl=hi)
- [বাংলা](https://web.dev/learn/pwa/service-workers?hl=bn)
- [ภาษาไทย](https://web.dev/learn/pwa/service-workers?hl=th)
- [中文 – 简体](https://web.dev/learn/pwa/service-workers?hl=zh-cn)
- [中文 – 繁體](https://web.dev/learn/pwa/service-workers?hl=zh-tw)
- [日本語](https://web.dev/learn/pwa/service-workers?hl=ja)
- [한국어](https://web.dev/learn/pwa/service-workers?hl=ko)

[Sign in](https://web.dev/_d/signin?continue=https%3A%2F%2Fweb.dev%2Flearn%2Fpwa%2Fservice-workers&prompt=select_account)

- [Resources](https://web.dev/learn)

- On this page
- [Register a service worker](https://web.dev/learn/pwa/service-workers#register)
  - [Verify whether a service worker is registered](https://web.dev/learn/pwa/service-workers#verify)
  - [Scope](https://web.dev/learn/pwa/service-workers#scope)
- [Lifecycle](https://web.dev/learn/pwa/service-workers#lifecycle)
  - [Update a service worker](https://web.dev/learn/pwa/service-workers#update)
- [Service worker lifespan](https://web.dev/learn/pwa/service-workers#lifespan)
- [Capabilities](https://web.dev/learn/pwa/service-workers#capabilities)
- [Resources](https://web.dev/learn/pwa/service-workers#resources)
...
![A service worker as a middleware proxy, running device-side, between your PWA and servers, which includes both your own servers and cross-domain servers.](https://web.dev/static/learn/pwa/service-workers/image/a-service-worker-a-middl-982e684894b75.png)A service worker acts as middleware between your
PWA and the servers it interacts with.
...
3. Check that the service worker's script URL appears with the status
"Activated". (For more information, see [Lifecycle](https://web.dev/learn/pwa/service-workers#lifecycle)). On Firefox,
the status can be "Running" or "Stopped".

In Safari:

1. Click **Develop** \> **Service Workers**.
2. Check this menu for an entry with the current origin. Clicking that entry
opens an inspector over the service worker's context.

![Service worker developer tools on Chrome, Firefox and Safari.](https://web.dev/static/learn/pwa/service-workers/image/service-worker-developer-5ebe49234dc0f.png)Service worker developer tools on Chrome, Firefox and Safari.
...
the _my-pwa_ path, such as `example.com/my-pwa/demos/`. Service workers can
control only items (pages, workers, collectively "clients") in their scope.
This scope applies to browser tabs and PWA windows.

Only _one_ service worker is allowed per scope. When a service worker is active
