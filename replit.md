...
│       │   ├── SyncQueueProvider.tsx  # Task sync queue (owns SyncOperation types) — isolated from task re-renders
│       │   ├── LocalStateProvider.tsx  # Local-first task state; enqueues onto SyncQueueProvider
│       │   ├── SyncProvider.tsx  # Background sync orchestrator (drains SyncQueue + Settings pending)
