...
const HowToInstall = () => (
  <ScrollablePage className="pb-16">
    ...
    <div className="space-y-6">
      ...
      <section data-testid="section-iphone">
        <h2 className="text-lg font-semibold mb-3 text-primary">
          <span className="flex items-center gap-2">
            <Smartphone className={IconSize.HW5} />
            iPhone / iPad (Safari)
          </span>
        </h2>
        <div className="space-y-3">
      ...
      <section data-testid="section-android">
        <h2 className="text-lg font-semibold mb-3 text-primary">
          <span className="flex items-center gap-2">
            <Smartphone className={IconSize.HW5} />
            Android (Chrome)
      ...
      <section data-testid="section-desktop">
        <h2 className="text-lg font-semibold mb-3 text-primary">
          <span className="flex items-center gap-2">
            <Globe className={IconSize.HW5} />
            Desktop (Chrome / Edge)
          </span>
        </h2>
        <div className="space-y-3">
